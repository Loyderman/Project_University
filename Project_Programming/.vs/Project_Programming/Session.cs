    ...
    public class Session
    {
        ...
        public void ChooseShipYouWantToCange()
        {
            ...
            else
            {
                ...
                {
                    Console.WriteLine($"{ship1.NameOfTheShip} index: {ship1.ShipIndex}");
                }
        ...
        public void InterfaceforRemovingSips()
        {
            ...
            else
            {
                ...
                switch (k)
                {
                    case 1:
                        {
                            Console.WriteLine("There are ships in your port system");
                            foreach (Ship s in templateShip.Ships)
                            {
                                {
        ...
        public void InterfaceOfShowingOfTheShip()
        {
            ...
            else
            {
                ...
                Console.WriteLine("1.Show information about each of ships");
                Console.WriteLine("2.Show information about particular ship");
                Console.WriteLine("3.Exit");
                Console.WriteLine("Print the number of option ypu want to choose");
                string str = Console.ReadLine();
                ...
                switch (str)
                {
                    ...
                    case "2":
                        {
                            ...
                            Console.WriteLine("Print the index of ship you want watch information about it:");
                            int index = Convert.ToInt32(Console.ReadLine());
                            foreach (Ship sh in ship.Ships)
                            {
                                {
                    ...
                    default:
                        {
                            Console.WriteLine("You have entered an inccorrecсt number");
                            break;
                        }
        ...
        public void InterfaceForShowingMember()
        {
            ...
            else
            {
                ...
                Console.WriteLine("Print the index of ship you want watch information about his members:");
                int index = Convert.ToInt32(Console.ReadLine());
                foreach (Ship sh in ship.Ships)
                {
                    ...
                    if (sh.ShipIndex == index)
                    {
                        if (sh.Crew.Count == 0)
                        {
                            Console.WriteLine("There are not members in this crew");
                            break;
                        }
        ...
        public void InterfaceForRemovingMembers()
        {
            ...
            else
            {
                ...
                Console.WriteLine("Print the index of ship you want remove member:");
                int index = Convert.ToInt32(Console.ReadLine());
                foreach (Ship sh in ship.Ships)
                {
                    ...
                    if (sh.ShipIndex == index)
                    {
                        ...
                        Console.WriteLine("There are members in ship");
                        foreach (CrewMember m in sh.Crew)
                        {

                            Console.WriteLine($"{m.ToString()}");
                        }
                        Console.WriteLine("Enter an snp of member you want to remove");
                        string i = Console.ReadLine();
                        for (int i2 = 0; i2 < ship.Crew.Count; i2++)
                        {
                            if (ship.Crew[i2].SNP == i)
                            {
                                ship.Crew.RemoveAt(i2);
                                break;
                            }
                        }
                        break;
